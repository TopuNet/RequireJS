...
//页面底部微信弹窗
define('app/UserControl',["lib/functions","lib/jquery.min"], function() {
    mouse_click();
...
define('modules/window_resize',["lib/jquery.min"], function() {
...
define('app/index',["modules/window_resize", "modules/goto_top", "lib/jquery.min"], function($window_resize, $goto_top) {
    var index = {
        init: function() {
...
if (typeof define === "function" && define.amd) {
    define('lib/baidu_map',["http://api.map.baidu.com/getscript?v=2.0&ak=cQoqZZ4o1Yy96sEiIlIVkkek"], function() {
        return baidu_map;
    });
}
...
define('app/contact',["lib/baidu_map", "lib/jquery.min"], function($baidu_map) {
    var contact = {
        init: function() {
            show_baidu_map();
        }
...
define('app',["app/UserControl", "lib/jquery.min"], function() {
